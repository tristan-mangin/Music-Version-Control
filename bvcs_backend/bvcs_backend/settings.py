"""
Django settings for bvcs_backend project.
...
SECRET_KEY = 'django-insecure-xcch&o&x!pb^(86%d^e(qxy)cm14#tr!)q123ike&utwqhgpni'
...
ROOT_URLCONF = 'bvcs_backend.urls'
...
WSGI_APPLICATION = 'bvcs_backend.wsgi.application'
